...
module.exports = component.register('gaia-header', {
  ...
  getTitleStyle: function(el, space) {
    ...
    if (overflowing) {
      ...
      // do not add any padding even if text overflows container since
      // haders are left-aligned according to styleguide
  ...
  template: `<div class="inner">
    ...
    <content select="h1,a,button,div"></content>
  </div>
  ...
  .inner {
    ...
    height: 50px;
    direction: ltr;
    padding-left: 10px; /* px according tp styleguides */
    padding-right: 10px; /* px according tp styleguides */
